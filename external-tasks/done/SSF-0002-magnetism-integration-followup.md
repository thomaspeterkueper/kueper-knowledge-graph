...
1. Die acht kanonischen Module `PHY-L1-000017` bis `PHY-L1-000024` sowie `PATH:SSF:MAGNETISM-MATERIALS` wurden auf einen frischen Integrationsstand vom aktuellen `main` übernommen.
