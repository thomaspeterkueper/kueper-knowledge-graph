...
KXF-Export v0.3.0 mit CHE-L1-000015 (water-processing) + ENG-L1-000005 (resource-extraction). /api/noxia/modules liest jetzt aus learningPaths.ts — KXF-Export-Sync-Problem umgangen.
